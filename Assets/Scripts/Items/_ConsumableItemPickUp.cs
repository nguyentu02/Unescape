...
namespace NT
{
    public class _ConsumableItemPickUp : Interactable
    {
        ...
        private void PickUpItem(PlayerManager playerManager)
        {
            ...
            if (consumable != null)
            {
                playerInventoryManager._consumablesInventory.Add(consumable);
                playerManager.itemInteractableGameObject.GetComponentInChildren<Text>().text = consumable.itemName;
                playerManager.itemInteractableGameObject.GetComponentInChildren<RawImage>().texture = consumable.itemIcon.texture;
